...
My solutions to the [LeetCode 75 Study Plan](https://leetcode.com/studyplan/leetcode-75/).

## How to run a solution

```bash
python 01_array_string/1768_merge_strings_alternately.py
```

Each file has an `if __name__ == "__main__":` block at the bottom — add your test cases there and run directly.
